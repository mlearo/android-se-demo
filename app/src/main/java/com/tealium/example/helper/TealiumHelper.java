...
public final class TealiumHelper {
    ...
    // Current acc, pro, env
    String currentAccount, CurrentPro, CurrentEnv;
    ...
    public static void initialize(Application application, String account, String profile, String env) {
        ...
        //final Tealium.Config config = Tealium.Config.create(application, "sales-mlearo", "mobile", "prod");
        final Tealium.Config config = Tealium.Config.create(application, account, profile , env);
        ...
        //instance.getDataSources().getVolatileDataSources().put("cp.trace_id", "07513");
        //instance.getDataSources().getVolatileDataSources().put("tealium_trace_id", "07513");

        //instance.joinTrace("07513");
